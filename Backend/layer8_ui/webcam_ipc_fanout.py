...
Set ``webrtc_smooth_display: 0`` in webcam settings to revert to the legacy
            ...
            async def recv(self) -> Any:
                ...
                with parent._lock:
                    ...
                    if self._smooth and parent._display_bgr is not None:
                        ...
                        src = parent._display_bgr
                    # Copy under lock so the pump cannot replace/mutate mid-encode.
...
_FanoutSingleton: WebcamIpcFanout | None = None
_FanoutLock = threading.Lock()


def get_webcam_ipc_fanout(
    *,
