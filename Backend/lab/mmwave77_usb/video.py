...
def render_cube_video(
    ...
    *,
    ...
    colorbar.set_label("Elevación (grados)", color="#c9d5e2", fontsize=9)
    ...
    with writer.saving(figure, str(output_path), dpi=dpi):
        for index, window in enumerate(hits):
            ...
            _style_axis(axis_3d, "Volumen x / profundidad / elevación")
            axis_3d.scatter(
            ...
            axis_3d.set(
                ...
                xlabel="x derecha (m)", ylabel="profundidad (m)", zlabel="altura z (m)",
            )
            ...
            _style_axis(axis_top, "Vista superior · azimut y profundidad")
            ...
            _style_axis(axis_side, "Vista lateral · profundidad y elevación")
